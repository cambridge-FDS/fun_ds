...
- Explain why code structure matters as much as models
- Transition from notebook code to modular Python packages
- Use Git and GitHub for collaborative data science
:::
