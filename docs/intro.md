...
3. **Extend.** Complete the *Exercises* at the end of each notebook and
...
D200 (*Machine Learning in Economics*) and D300 (*Causal Inference and
Machine Learning*) in Lent Term. This book emphasises the **applied
...
> Ochs, A. and Roerig, C. (2024–2025). *Fundamentals of Data Science*.
